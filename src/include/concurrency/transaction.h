 ...
 */
    enum class IsolationLevel {
        READ_UNCOMMITTED, REPEATABLE_READ, READ_COMMITTED
    };
 ...
 */
    ...
    public:
        // NOLINTNEXTLINE
        TableWriteRecord(table_oid_t tid, RID rid, TableHeap *table_heap) : tid_(tid), rid_(rid),
 ...
 */
    ...
    public:
        ...
        IndexWriteRecord(RID rid, table_oid_t table_oid, WType wtype, const Tuple &tuple, index_oid_t index_oid,
                         Catalog *catalog)
            : rid_(rid), table_oid_(table_oid), wtype_(wtype), tuple_(tuple), index_oid_(index_oid),
              catalog_(catalog) {}
 ...
 */
    ...
    public:
        ...
        inline auto
        GetExclusiveRowLockSet() -> std::shared_ptr<std::unordered_map<table_oid_t, std::unordered_set<RID>>> {
            return x_row_lock_set_;
        }

        /** @return the set of resources under a shared lock */
        inline auto
        GetSharedTableLockSet() -> std::shared_ptr<std::unordered_set<table_oid_t>> { return s_table_lock_set_; }
