...
// NOLINTNEXTLINE
    TEST(IsolationLevelTest, InsertTestA) {
        ExpectTwoTxn("InsertTestA.1", IsolationLevel::READ_UNCOMMITTED, IsolationLevel::READ_UNCOMMITTED, false,
                     IS_INSERT,
...
// NOLINTNEXTLINE
    TEST(IsolationLevelTest, DeleteTestA) {
        ExpectTwoTxn("DeleteTestA.1", IsolationLevel::READ_COMMITTED, IsolationLevel::READ_UNCOMMITTED, false,
                     IS_DELETE,
